package cz.upol.pja.lecture08.models;
...
@NamedQueries({
    @NamedQuery(
            name = "allDiscs",
            query = "select discs from Discussion discs"),
    @NamedQuery(
            name = "allPostsOfDiscussion",
            query = "select disc.posts from Discussion disc where disc.id = :discId")
})
@Entity
@Table(name = "lec05_discussions_6")
